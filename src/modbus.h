 ...
 *           It's good practice to return exception code 01 in case you receive
 * a function code that you haven't implemented in your application.
 */
#ifndef __MODBUS_H
#define __MODBUS_H
...
#define fcReadInputRegisters                                                   \
  4 // read analog input registers (2 Bytes per register)
...
#define fcPresetMultipleRegisters                                              \
  16 // write multiple analog output registers (2 Bytes each)
#define fcReportSlaveID                                                        \
  17 // read device description, run status and other device specific
     // information
